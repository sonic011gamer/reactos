    ...
    _Out_ PVOID SystemLogData)
{
    ...
    /*
     * Now capture the size of the system log file.
     * This must be a non-zero value otherwise this
     * log is kaput.
     */
    ...
    _In_ ULONG_PTR SystemLog)
{
    ...
    /*
     * Validate the base block header of the
     * SYSTEM hive. We will need to apply a
     * new header obtained from the log.
     */
    ...
    /*
     * Now copy the data from the SYSTEM log
     * to the primary hive.
     */
    ...
    /*
     * Fix up the secondary sequence and set up
     * a new checksum as we wrote data from the
     * SYSTEM log into the hive.
     */
    ...
    _In_ ULONG ChunkSize)
{
    ...
    {
        /*
         * The SYSTEM hive is corrupt. Recover
         * it with the SYSTEM log that we have
         * at disposal. Free the system hive buffer
         * first.
         */
