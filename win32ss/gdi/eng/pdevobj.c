    ...
    _In_ ULONG ldevtype)
{
    ...
    /* Initialize EDD_DIRECTDRAW_GLOBAL data */
    ...
    PPDEVOBJ ppdev2)
{
    ...
    /* Exchange EDD_DIRECTDRAW_GLOBAL PDEVs */
    ppdev->pEDDgpl->hDev = (HDEV)ppdev2;
    ppdev2->pEDDgpl->hDev = (HDEV)ppdev;
    ppdev->pEDDgpl->dhpdev = ppdev2->dhpdev;
    ppdev2->pEDDgpl->dhpdev = ppdev->dhpdev;
    ...
    PDEVMODEW pdm)
{
    ...
    {
        DPRINT1("Failed to enable DirectDraw\n");
        PDEVOBJ_vRelease(ppdevTmp);
        goto leave2;
    }
    ...
    /* Re-initialize EDD_DIRECTDRAW_GLOBAL data */
    ppdev->pEDDgpl->hDev = (HDEV)ppdev;
    ppdev->pEDDgpl->dhpdev = ppdev->dhpdev;
