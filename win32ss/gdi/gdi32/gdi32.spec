...
@ stdcall -stub -version=0x600+ D3DKMTDestroyDevice(ptr)
@ stdcall -stub -version=0x600+ D3DKMTDestroySynchronizationObject(ptr)
@ stdcall -stub -version=0x600+ D3DKMTEscape(ptr)
...
@ stdcall -stub -version=0x600+ D3DKMTGetScanLine(ptr)
...
@ stdcall -stub -version=0x600+ D3DKMTSetVidPnSourceOwner(ptr)
@ stdcall -stub -version=0x600+ D3DKMTSharedPrimaryLockNotification(ptr)
@ stdcall -stub -version=0x600+ D3DKMTSharedPrimaryUnLockNotification(ptr)
...
@ stdcall -stub -version=0x600+ D3DKMTDestroyOverlay(ptr)
@ stdcall -stub -version=0x600+ D3DKMTFlipOverlay(ptr)
@ stdcall -stub -version=0x600+ D3DKMTWaitForIdle(ptr)
@ stdcall -stub -version=0x600+ D3DKMTUpdateOverlay(ptr)
@ stdcall -stub -version=0x600+ D3DKMTUnlock(ptr)
@ stdcall -stub -version=0x600+ D3DKMTCreateOverlay(ptr)
