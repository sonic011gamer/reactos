...
611 stdcall -version=0x600+ D3DKMTEscape(ptr)
612 stdcall -version=0x600+ D3DKMTOpenAdapterFromHdc(ptr)
...
616 stdcall -version=0x600+ D3DKMTCloseAdapter(ptr)
617 stdcall -version=0x600+ D3DKMTCreateDevice(ptr)
618 stdcall -version=0x600+ D3DKMTDestroyDevice(ptr)
619 stdcall -version=0x600+ D3DKMTOpenAdapterFromGdiDisplayName(ptr)
620 stdcall -version=0x600+ D3DKMTSetVidPnSourceOwner(ptr)
621 stdcall -version=0x601+ D3DKMTCheckVidPnExclusiveOwnership(ptr)
@ stdcall -version=0x600+ DwmGetDirtyRgn() ;Vista specific
@ stdcall -version=0x600+ DwmGetSurfaceData() ;Vista Specific
@ stdcall -version=0x600+ D3DKMTCreateOverlay(ptr)
@ stdcall -version=0x600+ D3DKMTAcquireKeyedMutex(ptr)
@ stdcall -version=0x600+ D3DKMTConfigureSharedResource(ptr)
@ stdcall -version=0x600+ D3DKMTCreateAllocation(ptr)
@ stdcall -version=0x600+ D3DKMTCreateAllocation2(ptr)
@ stdcall -version=0x600+ D3DKMTCreateContext(ptr)
@ stdcall -version=0x600+ D3DKMTCreateSynchronizationObject(ptr)
@ stdcall -version=0x600+ D3DKMTCreateSynchronizationObject2(ptr)
@ stdcall -version=0x600+ D3DKMTDestroyAllocation(ptr)
@ stdcall -version=0x600+ D3DKMTDestroyContext(ptr)
@ stdcall -version=0x600+ D3DKMTDestroyKeyedMutex(ptr)
@ stdcall -version=0x600+ D3DKMTDestroySynchronizationObject(ptr)
@ stdcall -version=0x600+ D3DKMTGetContextSchedulingPriority(ptr)
@ stdcall -version=0x600+ D3DKMTGetDeviceSchedulingPriority(ptr)
...
@ stdcall -version=0x600+ D3DKMTGetThunkVersion(ptr)
...
@ stdcall -version=0x600+ D3DKMTOpenKeyedMutex(ptr)
@ stdcall -version=0x600+ D3DKMTOpenResource(ptr)
@ stdcall -version=0x600+ D3DKMTCheckExclusiveOwnership(ptr)
@ stdcall -version=0x600+ D3DKMTOpenResource2(ptr)
@ stdcall -version=0x600+ D3DKMTOpenSynchronizationObject(ptr)
...
@ stdcall -version=0x600+ D3DKMTReleaseKeyedMutex(ptr)
...
@ stdcall -version=0x600+ D3DKMTSetDeviceSchedulingPriority(ptr)
...
@ stdcall -version=0x600+ D3DKMTSignalSynchronizationObject2(ptr)
@ stdcall -version=0x600+ D3DKMTUnlock(ptr)
@ stdcall -version=0x600+ D3DKMTWaitForSynchronizationObject(ptr)
@ stdcall -version=0x600+ D3DKMTWaitForSynchronizationObject2(ptr)
