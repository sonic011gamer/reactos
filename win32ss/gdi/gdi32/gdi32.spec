...
@ stdcall -stub -version=0x600+ D3DKMTCreateAllocation2(ptr)
@ stdcall -stub -version=0x600+ D3DKMTCreateContext(ptr)
@ stdcall -stub -version=0x600+ D3DKMTCreateSynchronizationObject(ptr)
@ stdcall -stub -version=0x600+ D3DKMTCreateSynchronizationObject2(ptr)
@ stdcall -stub -version=0x600+ D3DKMTDestroyAllocation(ptr)
@ stdcall -stub -version=0x600+ D3DKMTDestroyContext(ptr)
@ stdcall -stub -version=0x600+ D3DKMTDestroyKeyedMutex(ptr)
@ stdcall -stub -version=0x600+ D3DKMTDestroySynchronizationObject(ptr)
@ stdcall -stub -version=0x600+ D3DKMTGetContextSchedulingPriority(ptr)
@ stdcall -stub -version=0x600+ D3DKMTGetDeviceSchedulingPriority(ptr)
@ stdcall -stub -version=0x600+ D3DKMTGetDeviceState(ptr)
@ stdcall -stub -version=0x600+ D3DKMTGetDisplayModeList(ptr)
@ stdcall -stub -version=0x600+ D3DKMTGetMultisampleMethodList(ptr)
@ stdcall -stub -version=0x600+ D3DKMTGetRuntimeData(ptr)
@ stdcall -stub -version=0x600+ D3DKMTGetSharedPrimaryHandle(ptr)
@ stdcall -stub -version=0x600+ D3DKMTGetThunkVersion(ptr)
@ stdcall -stub -version=0x600+ D3DKMTLock(ptr)
@ stdcall -stub -version=0x600+ D3DKMTOpenAdapterFromDeviceName(ptr)
@ stdcall -stub -version=0x600+ D3DKMTOpenKeyedMutex(ptr)
@ stdcall -stub -version=0x600+ D3DKMTOpenResource(ptr)
@ stdcall -stub -version=0x600+ D3DKMTOpenResource2(ptr)
@ stdcall -stub -version=0x600+ D3DKMTOpenSynchronizationObject(ptr)
@ stdcall -stub -version=0x600+ D3DKMTPresent(ptr)
@ stdcall -stub -version=0x600+ D3DKMTQueryAdapterInfo(ptr)
@ stdcall -stub -version=0x600+ D3DKMTQueryAllocationResidency(ptr)
@ stdcall -stub -version=0x600+ D3DKMTQueryResourceInfo(ptr)
@ stdcall -stub -version=0x600+ D3DKMTReleaseKeyedMutex(ptr)
@ stdcall -stub -version=0x600+ D3DKMTRender(ptr)
@ stdcall -stub -version=0x600+ D3DKMTSetAllocationPriority(ptr)
@ stdcall -stub -version=0x600+ D3DKMTSetContextSchedulingPriority(ptr)
@ stdcall -stub -version=0x600+ D3DKMTSetDeviceSchedulingPriority(ptr)
@ stdcall -stub -version=0x600+ D3DKMTSetDisplayMode(ptr)
@ stdcall -stub -version=0x600+ D3DKMTSetDisplayPrivateDriverFormat(ptr)
@ stdcall -stub -version=0x600+ D3DKMTSetGammaRamp(ptr)
@ stdcall -stub -version=0x600+ D3DKMTSignalSynchronizationObject(ptr)
@ stdcall -stub -version=0x600+ D3DKMTSignalSynchronizationObject2(ptr)
@ stdcall -stub -version=0x600+ D3DKMTUnlock(ptr)
@ stdcall -stub -version=0x600+ D3DKMTWaitForSynchronizationObject(ptr)
@ stdcall -stub -version=0x600+ D3DKMTWaitForSynchronizationObject2(ptr)
@ stdcall -stub -version=0x600+ D3DKMTWaitForVerticalBlankEvent(ptr)

@ stdcall -stub -version=0x600+ D3DKMTCheckMonitorPowerState(ptr)
@ stdcall -version=0x600+ D3DKMTCreateDCFromMemory(ptr) gdi32_vista.D3DKMTCreateDCFromMemory
@ stdcall -version=0x600+ D3DKMTDestroyDCFromMemory(ptr) gdi32_vista.D3DKMTDestroyDCFromMemory
@ stdcall -stub -version=0x600+ D3DKMTOpenAdapterFromLuid(ptr)
@ stdcall -stub -version=0x600+ D3DKMTQueryStatistics(ptr)
@ stdcall -stub -version=0x600+ D3DKMTQueryVideoMemoryInfo(ptr)
