...
;Windows 8 buillshit user32
@ stub -version=0x602+ CheckDBCSEnabledExt	
@ stub -version=0x602+ CheckProcessSession	
@ stub -version=0x602+ CreateDCompositionHwndTarget	
@ stub -version=0x602+ CreateWindowInBand	
@ stub -version=0x602+ DestroyDCompositionHwndTarget	
@ stub -version=0x602+ DwmControl	
@ stub -version=0x602+ DwmLockScreenUpdates	
@ stub -version=0x602+ DwmValidateWindow	
@ stub -version=0x602+ EnableMouseInPointer	
@ stub -version=0x602+ EvaluateProximityToPolygon	
@ stub -version=0x602+ EvaluateProximityToRect	
@ stub -version=0x602+ GetActiveProcess	
@ stub -version=0x602+ GetAutoRotationState	
@ stub -version=0x602+ GetCurrentInputMessageSource	
@ stub -version=0x602+ GetDesktopID	
@ stub -version=0x602+ GetDisplayAutoRotationPreferences	
@ stub -version=0x602+ GetLicensingType	
@ stub -version=0x602+ GetPointerCursorId	
@ stub -version=0x602+ GetPointerDevice	
@ stub -version=0x602+ GetPointerDeviceCursors	
@ stub -version=0x602+ GetPointerDeviceProperties	
@ stub -version=0x602+ GetPointerDeviceRects	
@ stub -version=0x602+ GetPointerDevices	
@ stub -version=0x602+ GetPointerFrameInfo	
@ stub -version=0x602+ GetPointerFrameInfoHistory	
@ stub -version=0x602+ GetPointerFramePenInfo	
@ stub -version=0x602+ GetPointerFramePenInfoHistory	
@ stub -version=0x602+ GetPointerFrameTouchInfo	
@ stub -version=0x602+ GetPointerFrameTouchInfoHistory	
@ stub -version=0x602+ GetPointerInfo	
@ stub -version=0x602+ GetPointerInfoHistory	
@ stub -version=0x602+ GetPointerPenInfo	
@ stub -version=0x602+ GetPointerPenInfoHistory	
@ stub -version=0x602+ GetPointerTouchInfo	
@ stub -version=0x602+ GetPointerTouchInfoHistory	
@ stub -version=0x602+ GetPointerType	
@ stub -version=0x602+ GetRawPointerDeviceData	
@ stub -version=0x602+ GetUnpredictedMessagePos	
@ stub -version=0x602+ GetWindowBand	
@ stub -version=0x602+ GetWindowFeedbackSetting	
@ stub -version=0x602+ InitializeTouchInjection	
@ stub -version=0x602+ InjectTabletButton	
@ stub -version=0x602+ InjectTouchInput	
@ stub -version=0x602+ IsImmersiveProcess	
@ stub -version=0x602+ IsMouseInPointerEnabled	
@ stub -version=0x602+ IsQueueAttached	
@ stub -version=0x602+ MBToWCSExt	
@ stub -version=0x602+ OutputWin32kPowerLog	
@ stub -version=0x602+ PackTouchHitTestingProximityEvaluation	
@ stub -version=0x602+ QueryBSDRWindow	
@ stub -version=0x602+ RefreshTouchSysParams	
@ stub -version=0x602+ RegisterBSDRWindow	
@ stub -version=0x602+ RegisterPointerDeviceNotifications	
@ stub -version=0x602+ RegisterPointerInputTarget	
@ stub -version=0x602+ RegisterSessionProcess	
@ stub -version=0x602+ RegisterTouchHitTestingWindow	
@ stub -version=0x602+ SetCalibrationData	
@ stub -version=0x602+ SetCoalescableTimer	
@ stub -version=0x602+ SetDisplayAutoRotationPreferences	
@ stub -version=0x602+ SetDisplayMapping	
@ stub -version=0x602+ SetLicensingType	
@ stub -version=0x602+ SetProcessRestrictionExemption	
@ stub -version=0x602+ SetTHQAPublicKey	
@ stub -version=0x602+ SetWindowBand	
@ stub -version=0x602+ SetWindowCompositionTransition	
@ stub -version=0x602+ SetWindowFeedbackSetting	
@ stub -version=0x602+ SkipPointerFrameMessages	
@ stub -version=0x602+ UnregisterPointerInputTarget	
@ stub -version=0x602+ UpdateDefaultDesktopThumbnail	
@ stub -version=0x602+ UserpIsProcessImmersive	
@ stub -version=0x602+ UserpSetProcessDesktopApp	
@ stub -version=0x602+ UserpSetProcessImmersive	
@ stub -version=0x602+ VerifyTHQBlob	
1502 stub -version=0x602+ user32dll_1502	
2010 stub -version=0x602+ user32dll_2010	
2503 stub -version=0x602+ user32dll_2503	
2504 stub -version=0x602+ user32dll_2504	
2505 stub -version=0x602+ user32dll_2505	
2506 stub -version=0x602+ user32dll_2506	
2507 stub -version=0x602+ user32dll_2507	
2508 stub -version=0x602+ user32dll_2508	
2509 stub -version=0x602+ user32dll_2509	
2510 stub -version=0x602+ user32dll_2510	
2511 stub -version=0x602+ user32dll_2511	
2512 stub -version=0x602+ user32dll_2512	
2513 stub -version=0x602+ user32dll_2513	
2514 stub -version=0x602+ user32dll_2514	
2515 stub -version=0x602+ user32dll_2515	
2516 stub -version=0x602+ user32dll_2516	
2517 stub -version=0x602+ user32dll_2517	
2518 stub -version=0x602+ user32dll_2518	
2519 stub -version=0x602+ user32dll_2519	
2520 stub -version=0x602+ user32dll_2520	
2521 stub -version=0x602+ user32dll_2521