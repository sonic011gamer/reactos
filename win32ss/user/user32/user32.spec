...
@ stdcall -stub -version=0x601+ CloseGestureInfoHandle(long)
@ stdcall -stub -version=0x601+ GetDisplayConfigBufferSizes(long ptr ptr)
@ stdcall -stub -version=0x601+ GetGestureInfo(long ptr)
@ stdcall -stub -version=0x601+ GetTouchInputInfo(long long ptr long)
@ stdcall -stub -version=0x601+ QueryDisplayConfig(long ptr ptr ptr ptr ptr)
@ stdcall -stub -version=0x601+ SetGestureConfig(long long long ptr long)
