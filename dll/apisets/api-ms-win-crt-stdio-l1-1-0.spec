...
@ stdcall __acrt_iob_func() msvcrt.__acrt_iob_func
@ stdcall -arch=i386 __p__commode() msvcrt.__p__commode
@ stdcall -arch=i386 __p__fmode() msvcrt.__p__fmode
@ stdcall __stdio_common_vfprintf() msvcrt.__stdio_common_vfprintf
@ stdcall __stdio_common_vfprintf_p() msvcrt.__stdio_common_vfprintf_p
@ stdcall __stdio_common_vfprintf_s() msvcrt.__stdio_common_vfprintf_s
@ stdcall __stdio_common_vfscanf() msvcrt.__stdio_common_vfscanf
@ stdcall __stdio_common_vfwprintf() msvcrt.__stdio_common_vfwprintf
@ stdcall __stdio_common_vfwprintf_p() msvcrt.__stdio_common_vfwprintf_p
@ stdcall __stdio_common_vfwprintf_s() msvcrt.__stdio_common_vfwprintf_s
@ stdcall __stdio_common_vfwscanf() msvcrt.__stdio_common_vfwscanf
@ stdcall __stdio_common_vsnprintf_s() msvcrt.__stdio_common_vsnprintf_s
@ stdcall __stdio_common_vsnwprintf_s() msvcrt.__stdio_common_vsnwprintf_s
@ stdcall __stdio_common_vsprintf() msvcrt.__stdio_common_vsprintf
@ stdcall __stdio_common_vsprintf_p() msvcrt.__stdio_common_vsprintf_p
@ stdcall __stdio_common_vsprintf_s() msvcrt.__stdio_common_vsprintf_s
@ stdcall __stdio_common_vsscanf() msvcrt.__stdio_common_vsscanf
@ stdcall __stdio_common_vswprintf() msvcrt.__stdio_common_vswprintf
@ stdcall __stdio_common_vswprintf_p() msvcrt.__stdio_common_vswprintf_p
@ stdcall __stdio_common_vswprintf_s() msvcrt.__stdio_common_vswprintf_s
@ stdcall __stdio_common_vswscanf() msvcrt.__stdio_common_vswscanf
...
@ stdcall _get_stream_buffer_pointers() msvcrt._get_stream_buffer_pointers
@ stub _getc_nolock
...
@ stdcall _set_fmode() msvcrt._set_fmode
