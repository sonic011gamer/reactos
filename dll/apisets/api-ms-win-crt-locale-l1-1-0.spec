...
@ stdcall _configthreadlocale() msvcrt._configthreadlocale
@ stub _create_locale
@ stub _free_locale
@ stub _get_current_locale
@ stdcall _getmbcp() msvcrt._getmbcp
@ stdcall _lock_locales() msvcrt._lock_locales
@ stdcall _setmbcp() msvcrt._setmbcp
@ stdcall _unlock_locales() msvcrt._unlock_locales
@ stdcall -stub _wcreate_locale(long ptr) 
