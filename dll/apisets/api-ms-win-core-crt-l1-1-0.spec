...
@ stdcall -arch=i386 -version=0x600+ _ftol2() msvcrt._ftol2
@ stdcall -arch=i386 -version=0x600+ _ftol2_sse() msvcrt._ftol2_sse
@ stdcall -arch=i386 -version=0x600+ _i64tow_s() msvcrt._i64tow_s
...
@ stdcall -version=0x600+ _snprintf_s() ntdll._snprintf_s
@ stdcall -version=0x600+  _snwprintf_s() ntdll._snwprintf_s
...
@ stdcall -stub -version=0x600+ _vsnprintf_s(ptr ptr ptr ptr)
@ stdcall -stub -version=0x600+ _vsnwprintf_s(ptr ptr ptr ptr)
