...
@ stdcall -version=0x601+ FlushProcessWriteBuffers() ntdll.NtFlushProcessWriteBuffers;
...
@ stdcall -version=0x601+ FreeLibraryWhenCallbackReturns	forwarded to NTDLL function TpCallbackUnloadDllOnCompletion;
@ stdcall -version=0x601+ FreeResource() kernel32.kernel32
...
@ stdcall -version=0x601+ GetCurrentDirectoryW() kernel32() kernel32.GetCurrentDirectoryW
@ stdcall -version=0x601+ GetCurrentProcess() kernel32.() kernel32.GetCurrentProcess
@ stdcall -version=0x601+ GetCurrentProcessId() kernel32.() kernel32.GetCurrentProcessId
...
@ stdcall -version=0x601+ GetFinalPathNameByHandleA	GetFinalPathNameByHandleA
@ stdcall -version=0x601+ GetFinalPathNameByHandleW	GetFinalPathNameByHandleW
...
@ stdcall -version=0x601+ GetLocaleInfoHelper() kernel32.GetLocaleInfoHelper
...
@ stdcall -version=0x601+ GetLogicalProcessorInformationEx() kernel32.GetLogicalProcessorInformationEx
...
@ stdcall -version=0x601+ QueryPerformanceCounter() ntdll.RtlQueryPerformanceCounter;
