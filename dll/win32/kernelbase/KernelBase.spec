...
@ stdcall -stub -version=0x601+ TrySubmitThreadpoolCallback() ;kernel32.TrySubmitThreadpoolCallback
...
@ stdcall -version=0x601+ PathAllocCanonicalize(ptr long ptr)
...
@ stdcall -version=0x601+ PathCchAddBackslash(ptr long)
@ stdcall -version=0x601+ PathCchAddBackslashEx(ptr long ptr ptr)
...
@ stdcall -version=0x601+ PathCchCanonicalizeEx(ptr long ptr long)
...
@ stdcall -version=0x601+ PathCchStripPrefix(ptr long)	
