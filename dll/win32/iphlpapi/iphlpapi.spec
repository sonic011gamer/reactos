...
@ stub do_echo_req
@ stub register_icmp
@ stdcall -stub ResolveIpNetEntry2(ptr ptr)
@ stdcall -stub -version=0x600+ CancelMibChangeNotify2(ptr)
@ stdcall -stub -version=0x600+ ConvertGuidToStringA( ptr ptr long )
@ stdcall -stub -version=0x600+ ConvertGuidToStringW( ptr ptr long )
@ stdcall -stub -version=0x600+ ConvertInterfaceAliasToLuid( ptr ptr )
...
@ stdcall -stub -version=0x600+ ConvertStringToGuidW( ptr ptr )
@ stdcall -stub -version=0x600+ CreateSortedAddressPairs(ptr long ptr long long ptr ptr)
@ stdcall -stub -version=0x600+ FreeMibTable(ptr)
@ stdcall -stub -version=0x600+ GetBestRoute2(ptr long ptr ptr long ptr ptr)
@ stdcall -stub -version=0x600+ GetIfEntry2(ptr)
@ stdcall -stub -version=0x600+ GetIfTable2Ex(long ptr)
@ stdcall -stub -version=0x600+ GetIfTable2(long ptr)
@ stdcall -stub -version=0x600+ GetIpForwardTable2( long ptr )
@ stdcall -stub -version=0x600+ GetIpInterfaceEntry(ptr)
@ stdcall -stub -version=0x600+ GetIpInterfaceTable( long ptr )
@ stdcall -stub -version=0x600+ GetIpNetEntry2(ptr)
@ stdcall -stub -version=0x600+ GetIpNetTable2( long ptr )
@ stdcall -stub -version=0x600+ GetTcp6Table( ptr ptr long )
@ stdcall -stub -version=0x600+ GetTcp6Table2( ptr ptr long )
@ stdcall -stub -version=0x600+ GetTcpTable2( ptr ptr long )
@ stdcall -stub -version=0x600+ GetTeredoPort(ptr)
@ stdcall -stub -version=0x600+ GetUdp6Table( ptr ptr long )
@ stdcall -stub -version=0x600+ GetUnicastIpAddressEntry( ptr )
@ stdcall -stub -version=0x600+ GetUnicastIpAddressTable(long ptr)
@ stdcall -stub -version=0x600+ IcmpSendEcho2Ex(ptr ptr ptr ptr long long ptr long ptr ptr long long)
@ stdcall -stub -version=0x600+ if_indextoname(long ptr)
@ stdcall -stub -version=0x600+ if_nametoindex(str)
@ stdcall -stub -version=0x600+ NotifyIpInterfaceChange(long ptr ptr long ptr)
@ stdcall -stub -version=0x600+ NotifyStableUnicastIpAddressTable(long ptr ptr ptr ptr)
@ stdcall -stub -version=0x600+ NotifyRouteChange2(ptr ptr ptr long ptr)
@ stdcall -stub -version=0x600+ NotifyUnicastIpAddressChange(long ptr ptr long ptr)
@ stdcall -stub -version=0x600+ ParseNetworkString(ptr long ptr ptr ptr)
@ stdcall -stub -version=0x600+ ResolveNeighbor(ptr ptr ptr)
@ stdcall -stub -version=0x600+ SetPerTcpConnectionEStats( ptr long ptr long long long )
