             ...
             IN HKEY hKeyDest)
{
    ...
    if (copyKeys != NULL)
    {
        ...
        /* DPRINT1 - copy security from hKeySrc to hKeyDest or just for the subkeys? */
        ...
        do
        {
            ...
            for (;;)
            {
                ...
                if (NT_SUCCESS(Status2))
                {
                    ...
                    if (NT_SUCCESS(Status2))
                    {
                        /* DPRINT1 - attempt to query the security information */
                    ...
                    PHKEY phkResult)
{
    ...
    else
    {
        ...
        if (GetComputerNameW(compName, &len))
        {
            ...
            {
                DPRINT1("Connect to %s is not supported.\n",debugstr_w(lpMachineName));
    ...
    _In_ DWORD Reserved)
{
    ...
    if (samDesired & KEY_WOW64_32KEY)
        DPRINT1("Wow64 not yet supported!\n");
                  ...
                  LPDWORD lpcbSecurityDescriptor)
{
    ...
    if (!NT_SUCCESS(Status))
    {
         DPRINT1("NtQuerySecurityObject() failed (Status %lx)\n", Status);
         return RtlNtStatusToDosError(Status);
    }
                        ...
                        BOOL fAsynchronous)
{
    ...
    /* DPRINT1: Remote key handles must fail */
                 ...
                 PFILETIME lpftLastWriteTime)
{
    ...
    if (lpcbSecurityDescriptor != NULL)
    {
        Status = NtQuerySecurityObject(KeyHandle,
                                       ...
                                       0,
                                       lpcbSecurityDescriptor);
        DPRINT("NtQuerySecurityObject() returned status 0x%X\n", Status);
    }
              ...
              DWORD Flags)
{
    ...
    DPRINT1("RegSaveKeyExW(): Flags ignored!\n");
