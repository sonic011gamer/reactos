...
117 stdcall -noname ApplyGroupPolicy(ptr)                                     #stdcall -noname ApplyGroupPolicy(20)
...
152 stdcall -noname IsSyncForegroundPolicyRefresh(ptr)                        #stdcall -noname IsSyncForegroundPolicyRefresh(8)
