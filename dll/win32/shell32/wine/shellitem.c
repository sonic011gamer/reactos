...
static inline ShellItemImpl *impl_from_IShellItem2(IShellItem2 *iface)
{
    return CONTAINING_RECORD(iface, ShellItemImpl, IShellItem2_iface);
}

static inline ShellItemImpl *impl_from_IPersistIDList( IPersistIDList *iface )
{
    return CONTAINING_RECORD(iface, ShellItemImpl, IPersistIDList_iface);
}
...
static HRESULT WINAPI ShellItemImpl_QueryInterface(IShellItem2 *iface, REFIID riid,
    void **ppv)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
...
static ULONG WINAPI ShellItemImpl_AddRef(IShellItem2 *iface)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
...
static ULONG WINAPI ShellItemImpl_Release(IShellItem2 *iface)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
...
static HRESULT ShellItemImpl_get_parent_pidl(ShellItemImpl *This, LPITEMIDLIST *parent_pidl)
{
...
static HRESULT ShellItemImpl_get_parent_shellfolder(ShellItemImpl *This, IShellFolder **ppsf)
{
    LPITEMIDLIST parent_pidl;
    IShellFolder *desktop;
    HRESULT ret;

    ret = ShellItemImpl_get_parent_pidl(This, &parent_pidl);
    if (SUCCEEDED(ret))
    {
...
static HRESULT ShellItemImpl_get_shellfolder(ShellItemImpl *This, IBindCtx *pbc, IShellFolder **ppsf)
{
    IShellFolder *desktop;
    HRESULT ret;
...
static HRESULT WINAPI ShellItemImpl_BindToHandler(IShellItem2 *iface, IBindCtx *pbc,
    REFGUID rbhid, REFIID riid, void **ppvOut)
{
    ...
    *ppvOut = NULL;
    ...
    {
        IShellFolder *psf;
        ret = ShellItemImpl_get_shellfolder(This, pbc, &psf);
        if (SUCCEEDED(ret))
        {
    ...
    else if (IsEqualGUID(rbhid, &BHID_SFUIObject))
    {
        ...
        if (_ILIsDesktop(This->pidl))
            ...
            ret = ShellItemImpl_get_parent_shellfolder(This, &psf_parent);
    ...
    {
        return ShellItemImpl_BindToHandler(&This->IShellItem2_iface, pbc, &BHID_SFUIObject,
...
static HRESULT WINAPI ShellItemImpl_GetParent(IShellItem2 *iface, IShellItem **ppsi)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
    LPITEMIDLIST parent_pidl;
    HRESULT ret;
...
static HRESULT WINAPI ShellItemImpl_GetDisplayName(IShellItem2 *iface, SIGDN sigdnName,
    LPWSTR *ppszName)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
...
static HRESULT WINAPI ShellItemImpl_GetAttributes(IShellItem2 *iface, SFGAOF sfgaoMask,
    SFGAOF *psfgaoAttribs)
{
    ...
    if (_ILIsDesktop(This->pidl))
        ...
        ret = ShellItemImpl_get_parent_shellfolder(This, &parent_folder);
    if (SUCCEEDED(ret))
    {
...
static HRESULT WINAPI ShellItemImpl_Compare(IShellItem2 *iface, IShellItem *oth,
...
static HRESULT WINAPI ShellItemImpl2_GetPropertyStore(IShellItem2 *iface, GETPROPERTYSTOREFLAGS flags,
...
static HRESULT WINAPI ShellItemImpl2_GetPropertyStoreWithCreateObject(IShellItem2 *iface,
...
static HRESULT WINAPI ShellItemImpl2_GetPropertyStoreForKeys(IShellItem2 *iface, const PROPERTYKEY *rgKeys,
...
static HRESULT WINAPI ShellItemImpl2_GetPropertyDescriptionList(IShellItem2 *iface,
...
static HRESULT WINAPI ShellItemImpl2_Update(IShellItem2 *iface, IBindCtx *pbc)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
    FIXME("Stub: %p (%p)\n", This, pbc);
    return E_NOTIMPL;
...
static HRESULT WINAPI ShellItemImpl2_GetProperty(IShellItem2 *iface, REFPROPERTYKEY key, PROPVARIANT *ppropvar)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
    FIXME("Stub: %p (%p, %p)\n", This, key, ppropvar);
    return E_NOTIMPL;
...
static HRESULT WINAPI ShellItemImpl2_GetCLSID(IShellItem2 *iface, REFPROPERTYKEY key, CLSID *pclsid)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
    FIXME("Stub: %p (%p, %p)\n", This, key, pclsid);
    return E_NOTIMPL;
...
static HRESULT WINAPI ShellItemImpl2_GetFileTime(IShellItem2 *iface, REFPROPERTYKEY key, FILETIME *pft)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
    FIXME("Stub: %p (%p, %p)\n", This, key, pft);
    return E_NOTIMPL;
...
static HRESULT WINAPI ShellItemImpl2_GetInt32(IShellItem2 *iface, REFPROPERTYKEY key, int *pi)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
    FIXME("Stub: %p (%p, %p)\n", This, key, pi);
    return E_NOTIMPL;
...
static HRESULT WINAPI ShellItemImpl2_GetString(IShellItem2 *iface, REFPROPERTYKEY key, LPWSTR *ppsz)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
    FIXME("Stub: %p (%p, %p)\n", This, key, ppsz);
    return E_NOTIMPL;
...
static HRESULT WINAPI ShellItemImpl2_GetUInt32(IShellItem2 *iface, REFPROPERTYKEY key, ULONG *pui)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
    FIXME("Stub: %p (%p, %p)\n", This, key, pui);
    return E_NOTIMPL;
...
static HRESULT WINAPI ShellItemImpl2_GetUInt64(IShellItem2 *iface, REFPROPERTYKEY key, ULONGLONG *pull)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
    FIXME("Stub: %p (%p, %p)\n", This, key, pull);
    return E_NOTIMPL;
...
static HRESULT WINAPI ShellItemImpl2_GetBool(IShellItem2 *iface, REFPROPERTYKEY key, BOOL *pf)
{
    ShellItemImpl *This = impl_from_IShellItem2(iface);
    FIXME("Stub: %p (%p, %p)\n", This, key, pf);
    return E_NOTIMPL;
...
#ifdef __REACTOS__
static IShellItem2Vtbl ShellItemImpl2_Vtbl = {
#else
static const IShellItem2Vtbl ShellItemImpl2_Vtbl = {
#endif
    ShellItemImpl_QueryInterface,
    ShellItemImpl_AddRef,
    ShellItemImpl_Release,
    ShellItemImpl_BindToHandler,
    ShellItemImpl_GetParent,
    ShellItemImpl_GetDisplayName,
    ShellItemImpl_GetAttributes,
    ShellItemImpl_Compare,
    ShellItemImpl2_GetPropertyStore,
    ShellItemImpl2_GetPropertyStoreWithCreateObject,
    ShellItemImpl2_GetPropertyStoreForKeys,
    ShellItemImpl2_GetPropertyDescriptionList,
    ShellItemImpl2_Update,
    ShellItemImpl2_GetProperty,
    ShellItemImpl2_GetCLSID,
    ShellItemImpl2_GetFileTime,
    ShellItemImpl2_GetInt32,
    ShellItemImpl2_GetString,
    ShellItemImpl2_GetUInt32,
    ShellItemImpl2_GetUInt64,
    ShellItemImpl2_GetBool
};

static HRESULT WINAPI ShellItemImpl_IPersistIDList_QueryInterface(IPersistIDList *iface,
    REFIID riid, void **ppv)
{
    ShellItemImpl *This = impl_from_IPersistIDList(iface);
    return IShellItem2_QueryInterface(&This->IShellItem2_iface, riid, ppv);
}

static ULONG WINAPI ShellItemImpl_IPersistIDList_AddRef(IPersistIDList *iface)
{
    ShellItemImpl *This = impl_from_IPersistIDList(iface);
    return IShellItem2_AddRef(&This->IShellItem2_iface);
}

static ULONG WINAPI ShellItemImpl_IPersistIDList_Release(IPersistIDList *iface)
{
    ShellItemImpl *This = impl_from_IPersistIDList(iface);
    return IShellItem2_Release(&This->IShellItem2_iface);
}

static HRESULT WINAPI ShellItemImpl_IPersistIDList_GetClassID(IPersistIDList* iface,
    CLSID *pClassID)
{
...
static HRESULT WINAPI ShellItemImpl_IPersistIDList_SetIDList(IPersistIDList* iface,
    LPCITEMIDLIST pidl)
{
    ShellItemImpl *This = impl_from_IPersistIDList(iface);
...
static HRESULT WINAPI ShellItemImpl_IPersistIDList_GetIDList(IPersistIDList* iface,
    LPITEMIDLIST *ppidl)
{
    ShellItemImpl *This = impl_from_IPersistIDList(iface);
...
#ifdef __REACTOS__
static IPersistIDListVtbl ShellItemImpl_IPersistIDList_Vtbl = {
#else
static const IPersistIDListVtbl ShellItemImpl_IPersistIDList_Vtbl = {
#endif
    ShellItemImpl_IPersistIDList_QueryInterface,
    ShellItemImpl_IPersistIDList_AddRef,
    ShellItemImpl_IPersistIDList_Release,
    ShellItemImpl_IPersistIDList_GetClassID,
    ShellItemImpl_IPersistIDList_SetIDList,
    ShellItemImpl_IPersistIDList_GetIDList
};
...
HRESULT WINAPI IShellItem_Constructor(IUnknown *pUnkOuter, REFIID riid, void **ppv)
{
    ...
    *ppv = NULL;
    ...
    This->IShellItem2_iface.lpVtbl = &ShellItemImpl2_Vtbl;
    This->ref = 1;
    This->pidl = NULL;
    This->IPersistIDList_iface.lpVtbl = &ShellItemImpl_IPersistIDList_Vtbl;
...
#ifdef __REACTOS__
static IEnumShellItemsVtbl vt_IEnumShellItems = {
#else
...
#ifdef __REACTOS__
static IShellItemArrayVtbl vt_IShellItemArray = {
#else
...
HRESULT WINAPI SHCreateShellItemArrayFromDataObject(IDataObject *pdo, REFIID riid, void **ppv)
{
    ...
    *ppv = NULL;
    ...
    if(SUCCEEDED(ret))
    {
        ...
        HeapFree(GetProcessHeap(), 0, (LPVOID)children);
...
#ifdef __REACTOS__
static ICustomDestinationListVtbl CustomDestinationListVtbl =
#else
