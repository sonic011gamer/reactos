...
@ stdcall -stub -version=0x600+ BufferedPaintClear(ptr ptr)
@ stdcall -stub -version=0x600+ BufferedPaintRenderAnimation(ptr ptr)
@ stdcall -stub -version=0x600+ BufferedPaintSetAlpha(ptr ptr long)
@ stdcall -stub -version=0x600+ BufferedPaintStopAllAnimations(ptr)
...
@ stdcall -stub -version=0x600+ FreeThemePropertyValues(ptr)
@ stdcall -stub -version=0x600+ FreeThemeSymbols(ptr)
@ stdcall -stub -version=0x600+ GetBufferedPaintBits(ptr ptr ptr)
@ stdcall -stub -version=0x600+ GetBufferedPaintDC(ptr)
@ stdcall -stub -version=0x600+ GetBufferedPaintTargetDC(ptr)
