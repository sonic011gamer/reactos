...
@  stdcall -version=0x600+ BeginBufferedAnimation(ptr ptr ptr ptr ptr ptr ptr ptr)
@  stdcall -version=0x600+ BeginBufferedPaint(ptr ptr ptr ptr ptr)
@  stdcall -stub -version=0x601+ BeginPanningFeedback(ptr)
@  stdcall -version=0x600+ BufferedPaintClear(ptr ptr)
@  stdcall -version=0x600+ BufferedPaintInit()
@  stdcall -version=0x600+ BufferedPaintRenderAnimation(ptr ptr)
@  stdcall -version=0x600+ BufferedPaintSetAlpha(ptr ptr long)
@  stdcall -version=0x600+ BufferedPaintStopAllAnimations(ptr)
@  stdcall -version=0x600+ BufferedPaintUnInit()
@  stdcall -stub -version=0x600+ DrawThemeParentBackgroundEx(ptr ptr long ptr)
@  stdcall -stub -version=0x600+ DrawThemeTextEx(ptr ptr long long wstr long long ptr ptr)
@  stdcall -version=0x600+ EndBufferedAnimation(ptr long)
@  stdcall -version=0x600+ EndBufferedPaint(ptr long)
@  stdcall -stub -version=0x601+ EndPanningFeedback(ptr long)
@  stdcall -version=0x600+ GetBufferedPaintBits(ptr ptr long)
@  stdcall -version=0x600+ GetBufferedPaintDC(ptr)
@  stdcall -version=0x600+ GetBufferedPaintTargetDC(ptr)
@  stdcall -version=0x600+ GetBufferedPaintTargetRect(ptr ptr)
@  stdcall -stub -version=0x600+ GetThemeTransitionDuration(ptr long long long long long)
