...
@ stdcall -stub -version=0x600+ RtlAddMandatoryAce(ptr long long long long ptr)
...
@ stdcall -stub -version=0x600+ RtlCompareUnicodeStrings(ptr long ptr long long) ntdll_vista.RtlCompareUnicodeStrings
...
@ stdcall -stub -version=0x600+ RtlGetCurrentProcessorNumberEx(ptr)
...
@ stdcall -stub -version=0x601+ RtlGetLocaleFileMappingAddress(ptr ptr long)
...
@ stdcall -stub -version=0x600+ RtlQueryPerformanceCounter(ptr) ntdll_vista.RtlQueryPerformanceCounter
...
@ stdcall -stub -version=0x600+ ZwQueryLicenseValue(wstr long ptr long long) ntdll_vista.ZwQueryLicenseValue
