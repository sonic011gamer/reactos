...
@ stdcall -arch=x86_64,arm,arm64 RtlActivateActivationContextUnsafeFast(ptr ptr)
...
@ stdcall -arch=x86_64,arm,arm64 RtlDeactivateActivationContextUnsafeFast(ptr)
