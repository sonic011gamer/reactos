...
@ stdcall -version=0x600+ RtlConnectToSm(ptr ptr long ptr)
...
@ stdcall  -version=0x600+ RtlFlsAlloc(long long long long)
...
@ stdcall -version=0x600+ RtlProcessFlsData(long long)
...
@ stdcall -version=0x600+ RtlSendMsgToSm(ptr ptr)
...
@ stdcall -stub -version=0x600+ TpAllocPool(ptr ptr) ntdll_vista.TpAllocPool
@ stdcall -stub -version=0x600+ TpAllocTimer(ptr ptr ptr ptr) ntdll_vista.TpAllocTimer
@ stdcall -stub -version=0x600+ TpAllocWait(ptr ptr ptr ptr) ntdll_vista.TpAllocWait
@ stdcall -stub -version=0x600+ TpAllocWork(ptr ptr ptr ptr) ntdll_vista.TpAllocWork
@ stdcall -stub -version=0x600+ TpCallbackLeaveCriticalSectionOnCompletion(ptr ptr) ntdll_vista.TpCallbackLeaveCriticalSectionOnCompletion
@ stdcall -stub -version=0x600+ TpCallbackMayRunLong(ptr) ntdll_vista.TpCallbackMayRunLong
@ stdcall -stub -version=0x600+ TpCallbackReleaseMutexOnCompletion(ptr ptr) ntdll_vista.TpCallbackReleaseMutexOnCompletion
@ stdcall -stub -version=0x600+ TpCallbackReleaseSemaphoreOnCompletion(ptr ptr long) ntdll_vista.TpCallbackReleaseSemaphoreOnCompletion
@ stdcall -stub -version=0x600+ TpCallbackSetEventOnCompletion(ptr ptr) ntdll_vista.TpCallbackSetEventOnCompletion
@ stdcall -stub -version=0x600+ TpCallbackUnloadDllOnCompletion(ptr ptr) ntdll_vista.TpCallbackUnloadDllOnCompletion
@ stdcall -stub -version=0x600+ TpCancelAsyncIoOperation(ptr) ntdll_vista.TpCancelAsyncIoOperation
@ stdcall -stub -version=0x600+ TpCaptureCaller(long) ntdll_vista.TpCaptureCaller
@ stdcall -stub -version=0x600+ TpCheckTerminateWorker(ptr) ntdll_vista.TpCheckTerminateWorker
@ stdcall -stub -version=0x600+ TpDbgDumpHeapUsage(long ptr long) ntdll_vista.TpDbgDumpHeapUsage
@ stdcall -stub -version=0x600+ TpDbgSetLogRoutine() ntdll_vista.TpDbgSetLogRoutine
@ stdcall -stub -version=0x600+ TpDisassociateCallback(ptr) ntdll_vista.TpDisassociateCallback
@ stdcall -stub -version=0x600+ TpIsTimerSet(ptr) ntdll_vista.TpIsTimerSet
@ stdcall -stub -version=0x600+ TpPostWork(ptr long long) ntdll_vista.TpPostWork
@ stdcall -stub -version=0x600+ TpReleaseAlpcCompletion(ptr) ntdll_vista.TpReleaseAlpcCompletion
@ stdcall -stub -version=0x600+ TpReleaseCleanupGroup(ptr) ntdll_vista.TpReleaseCleanupGroup
@ stdcall -stub -version=0x600+ TpReleaseCleanupGroupMembers(ptr long ptr) ntdll_vista.TpReleaseCleanupGroupMembers
@ stdcall -stub -version=0x600+ TpReleaseIoCompletion(ptr) ntdll_vista.TpReleaseIoCompletion
@ stdcall -stub -version=0x600+ TpReleasePool(ptr) ntdll_vista.TpReleasePool
@ stdcall -stub -version=0x600+ TpReleaseTimer(ptr) ntdll_vista.TpReleaseTimer
@ stdcall -stub -version=0x600+ TpReleaseWait(ptr) ntdll_vista.TpReleaseWait
@ stdcall -stub -version=0x600+ TpReleaseWork(ptr) ntdll_vista.TpReleaseWork
@ stdcall -stub -version=0x600+ TpSetPoolMaxThreads(ptr long) ntdll_vista.TpSetPoolMaxThreads
@ stdcall -stub -version=0x600+ TpSetPoolMinThreads(ptr long) ntdll_vista.TpSetPoolMinThreads
@ stdcall -stub -version=0x600+ TpSetTimer(ptr ptr long long) ntdll_vista.TpSetTimer
@ stdcall -stub -version=0x600+ TpSetWait(ptr ptr ptr) ntdll_vista.TpSetWait
@ stdcall -stub -version=0x600+ TpSimpleTryPost(ptr ptr ptr) ntdll_vista.TpSimpleTryPost
@ stdcall -stub -version=0x600+ TpStartAsyncIoOperation(ptr long long long) ntdll_vista.TpStartAsyncIoOperation
@ stdcall -stub -version=0x600+ TpWaitForAlpcCompletion(ptr) ntdll_vista.TpWaitForAlpcCompletion
@ stdcall -stub -version=0x600+ TpWaitForIoCompletion(ptr long) ntdll_vista.TpWaitForIoCompletion
@ stdcall -stub -version=0x600+ TpWaitForTimer(ptr long) ntdll_vista.TpWaitForTimer
@ stdcall -stub -version=0x600+ TpWaitForWait(ptr long) ntdll_vista.TpWaitForWait
@ stdcall -stub -version=0x600+ TpWaitForWork(ptr long) ntdll_vista.TpWaitForWork
