...
void write_dword_unknown(char **ptr, DWORD d)
{
  ...
  //  write_dword((DWORD*)ptr, (UINT32*)&d);
}

void write_dword(DWORD* location, DWORD* offset, const DWORD write)
{
...
static HRESULT shader_parse_signature(const char *data, DWORD data_size, struct d3d10_effect_shader_signature *s)
{
    ...
    for (i = 0; i < count; ++i)
    {
        ...
        read_dword(&ptr, (UINT32*)&e[i].SystemValueType);
        read_dword(&ptr, (UINT32*)&e[i].ComponentType);
...
static HRESULT shader_chunk_handler(const char *data, DWORD data_size, DWORD tag, void *ctx)
{
    ...
    switch(tag)
    {
        ...
        case TAG_OSGN:
        {
            ...
            //write_dword((DWORD*)&ptr, (DWORD*)TAG_DXBC); What
