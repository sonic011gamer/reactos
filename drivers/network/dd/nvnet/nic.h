...
#define NV_RX_RUNT    (1<<23)
#define NV_RX_LATECOLLISION    (1<<24)
#define NV_RX_ERROR3    (1<<25)
#define NV_RX_LENGTH_ERROR    (1<<26)
#define NV_RX_CRCERR    (1<<27)
#define NV_RX_OVERFLOW    (1<<28)
#define NV_RX_FRAMINGERR  (1<<29)
#define NV_RX_ERROR    (1<<30)
#define NV_RX_AVAIL    (1<<31)
#define NV_RX_ERROR_MASK  (NV_RX_RUNT|NV_RX_LATECOLLISION|NV_RX_ERROR3|NV_RX_LENGTH_ERROR| \
                           NV_RX_CRCERR| NV_RX_OVERFLOW|NV_RX_FRAMINGERR)
...
#define NV_RX2_RUNT    (1<<18)
#define NV_RX2_LATECOLLISION    (1<<19)
#define NV_RX2_ERROR3    (1<<20)
#define NV_RX2_LENGTH_ERROR    (1<<21)
...
#define NV_RX2_ERROR_MASK  (NV_RX2_RUNT|NV_RX2_LATECOLLISION|NV_RX2_ERROR3|NV_RX2_LENGTH_ERROR| \
