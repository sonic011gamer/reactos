...
BOOLEAN
NTAPI
SynchronizeVidSchNotifyInterrupt(_In_ PVOID SynchronizeContext)
{
    ...
    SYNC_NOTIFY_INTERRUPT* pParam = reinterpret_cast<SYNC_NOTIFY_INTERRUPT*>(SynchronizeContext);
...
VOID
NTAPI
HwContextWorkerThread(_In_ PVOID StartContext)
{
    PAGED_CODE();
    ...
    HwExecutePresentDisplayOnly(StartContext);
}
