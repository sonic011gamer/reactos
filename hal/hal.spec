...
@ stdcall -version=0x502 -arch=x86_64 x86BiosAllocateBuffer()
...
@ stdcall -version=0x600+ x86BiosAllocateBuffer(long long long)
@ stdcall -version=0x600+ x86BiosCall(long ptr)
@ stdcall -version=0x600+ x86BiosFreeBuffer(long long)
@ stdcall -version=0x600+ x86BiosReadMemory(long long ptr long)
@ stdcall -version=0x600+ x86BiosWriteMemory(long long ptr long)
