...
@ stdcall -stub -version=0x600+ HalGetMessageRoutingInfo(ptr) ;bad
@ stdcall -stub -version=0x600+ HalGetInterruptTargetInformation(ptr) ;bad
@ stdcall -stub -version=0x600+ HalStartDynamicProcessor(ptr)
@ stdcall -stub -version=0x600+ HalConvertDeviceIdtToIrql(ptr)
@ stdcall -stub -version=0x600+ HalQueryEnvironmentVariableInfoEx(ptr)
@ stdcall -stub -version=0x600+ HalBugCheckSystem(ptr)
@ stdcall -stub -version=0x600+ HalDynamicProcessorStarted(ptr)
@ stdcall -stub -version=0x600+ HalDisableInterrupt(ptr)
@ stdcall -stub -version=0x600+ HalGetEnvironmentVariableEx(ptr)
@ stdcall -stub -version=0x600+ HalEnumerateEnvironmentVariablesEx	(ptr)
@ stdcall -stub -version=0x600+ HalEnumerateProcessors(ptr)
@ stdcall -stub -version=0x600+ HalGetProcessorIdByNtNumber(ptr)
@ stdcall -stub -version=0x600+ HalGetVectorInput(ptr)
@ stdcall -stub -version=0x600+ HalInitializeOnResume(ptr)
;@ stdcall -stub -version=0x600+ HalInitializeBios(ptr)
@ stdcall -stub -version=0x600+ HalQueryMaximumProcessorCount(ptr)
@ stdcall -stub -version=0x600+ HalSetEnvironmentVariableEx(ptr)
@ stdcall -stub -version=0x600+ HalRegisterDynamicProcessor(ptr)
@ stdcall -stub -version=0x600+ HalRegisterErrataCallbacks(ptr)
...
@ stdcall x86BiosAllocateBuffer(long long long)
@ stdcall x86BiosCall(long ptr)
@ stdcall x86BiosFreeBuffer(long long)
@ stdcall x86BiosReadMemory(long long ptr long)
@ stdcall x86BiosWriteMemory(long long ptr long)
