...
@ stdcall PoFxIdleComponent(ptr ptr long)
@ stdcall PoFxPowerControl(ptr ptr ptr long ptr long ptr)
@ stdcall PoFxRegisterDevice(ptr ptr ptr)
@ stdcall PoFxReportDevicePoweredOn(ptr)
@ stdcall PoFxSetComponentLatency(ptr long int64)
@ stdcall PoFxSetComponentResidency(ptr long int64)
@ stdcall PoFxSetDeviceIdleTimeout(ptr int64)
