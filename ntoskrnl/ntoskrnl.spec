...
@ stdcall -stub -version=0x600+ EmClientQueryRuleState()
@ stdcall -version=0x600+ EtwActivityIdControl(long ptr)
@ stdcall -version=0x600+ EtwEventEnabled(int64 ptr)
@ stdcall -version=0x600+ EtwProviderEnabled(int64 long int64)
...
@ stdcall -version=0x600+ IoAllocateSfioStreamIdentifier(ptr long ptr ptr)
...
@ stdcall -version=0x600+ IoCreateArcName(ptr)
...
@ stdcall -version=0x600+ IoFreeSfioStreamIdentifier(ptr ptr)
@ stdcall IoFreeWorkItem(ptr)
@ stdcall -version=0x600+ IoGetActivityIdIrp(ptr ptr)
@ stdcall -version=0x600+ IoGetAffinityInterrupt(ptr ptr)
...
@ stdcall -version=0x600+ IoGetSfioStreamIdentifier(ptr ptr)
...
@ stdcall -version=0x600+ IoReportInterruptActive(ptr)
@ stdcall -version=0x600+ IoReportInterruptInactive(ptr)
...
@ stdcall -version=0x600+ KeGetProcessorNumberFromIndex(long ptr)
@ stdcall -version=0x600+ KeGetProcessorIndexFromNumber(ptr)
...
@ stdcall -version=0x600+ KeQueryActiveGroupCount()
...
@ stdcall -version=0x600+ KeQueryGroupAffinity(long)
...
@ stdcall -version=0x600+ KeQueryUnbiasedInterruptTime()
...
@ stdcall -version=0x600+ KeSetTargetProcessorDpcEx(ptr ptr)
...
@ stdcall -stub -version=0x600+ KseRegisterShim(ptr ptr long)
...
@ fastcall -version=0x600+ ObfReferenceObjectWithTag(ptr long)
...
@ stdcall -version=0x600+ PoEndDeviceBusy(ptr)
@ stdcall -version=0x600+ PoFxActivateComponent(ptr long long)
@ stdcall -version=0x600+ PoFxCompleteDevicePowerNotRequired(ptr)
@ stdcall -version=0x600+ PoFxCompleteIdleCondition(ptr long)
@ stdcall -version=0x600+ PoFxCompleteIdleState(ptr long)
@ stdcall -version=0x600+ PoFxIdleComponent(ptr ptr long)
@ stdcall -version=0x600+ PoFxPowerControl(ptr ptr ptr long ptr long ptr)
@ stdcall -version=0x600+ PoFxRegisterDevice(ptr ptr ptr)
@ stdcall -version=0x600+ PoFxReportDevicePoweredOn(ptr)
@ stdcall -version=0x600+ PoFxSetComponentLatency(ptr long int64)
@ stdcall -version=0x600+ PoFxSetComponentResidency(ptr long int64)
@ stdcall -version=0x600+ PoFxSetDeviceIdleTimeout(ptr int64)
@ stdcall -version=0x600+ PoFxStartDevicePowerManagement(ptr)
@ stdcall -version=0x600+ PoFxUnregisterDevice(ptr)
...
@ stdcall -version=0x600+ PoSetDeviceBusyEx(ptr)
...
@ stdcall -version=0x600+ PoStartDeviceBusy(ptr)
...
@ stdcall -stub -version=0x600+ RtlCheckPortableOperatingSystem(long)
...
@ stdcall -version=0x600+ RtlQueryRegistryValuesEx(long wstr ptr ptr ptr)
...
@ stdcall -stub -version=0x600+ RtlSetPortableOperatingSystem(long)
