...
@ stdcall -arch=x86_64,arm ExAcquireFastMutex(ptr)
...
@ stdcall -arch=x86_64,arm ExReleaseFastMutex(ptr)
...
@ cdecl -arch=x86_64,arm KeReleaseInStackQueuedSpinLock(ptr)
...
@ cdecl -arch=x86_64,arm KeReleaseQueuedSpinLock(long long)
@ stdcall KeReleaseSemaphore(ptr long long long)
@ stdcall -arch=x86_64,arm KeReleaseSpinLock(ptr long)
